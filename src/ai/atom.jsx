  ...
  getNextCard: (hand, targets, opponentPlays) => {
    ...
    const pick = (a, b) =>
      ...
      return hand.includes(13) ? 13 : hand[0]
        ...
        return hand.includes(1) ? 1 : hand[0]
      ...
      return hand.includes(6) ? 6 : hand[0];
    } else if (nextTarget === 7) {
      return hand.includes(7) ? 7 : hand[0];
    } else if (nextTarget === 8) {
      return hand.includes(8) ? 8 : hand[0];
    } else if (nextTarget === 9) {
      return hand.includes(9) ? 9 : hand[0];
    } else if (nextTarget === 10) {
      return hand.includes(10) ? 10 : hand[0];
    } else if (nextTarget === 11) {
      return hand.includes(11) ? 11 : hand[0];
    }
  return hand[0];
}
}
